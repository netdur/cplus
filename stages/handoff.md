...
Stage 4  facet_appkit        PLANNED stages/4.md rewritten 2026-08-04: the old
                                    "headless suite" stub was absorbed by Stage 3
                                    (the fake renderer IS the null backend; 433
                                    tests are the gate). Stage 4 = the contract on
                                    a Mac: window shell, create/apply sweep,
                                    Scheduler/KeyReader/SenderReaders, the 58
                                    deferred tier rows, agent.cplus, examples.
